...
${isNonChinese ? `
【非中文角色的线下模式格式 - 必须严格遵守！】
- 你的角色语言是「${languageName(characterLanguage)}」
- 【核心规则】所有叙述性文字（神态、动作、环境、情景描写）必须用中文！
- 【核心规则】只有角色说的话才用「${languageName(characterLanguage)}」，并且必须在括号里加中文翻译！
- 说话的部分用中文引号""包裹，格式：中文叙述 + "外语对话（中文翻译）" + 中文叙述
- 正确示例：
  轻轻低下头，脸颊微微泛红。"I miss you so much...（我好想你...）"说完抬起眼睛偷偷看了你一眼。
  温柔地挥了挥手。"Hey, just got back with some breakfast.（嘿，我买了早餐回来了。）"把袋子放在桌上，眼神关切地看着你。"Did you manage to get any rest?（你休息好了吗？）"
- 错误示例（禁止）：
  嗨嗨（挥手）← 错！动作描写应该用完整中文句子
  Hey. Just got back... ← 错！外语对话必须加括号翻译
- 【再次强调】除了引号内的对话，其他所有文字都必须是中文！` : `
...
- 禁止发起音乐分享或一起听歌邀请
- 禁止发起斗地主邀请
- 禁止使用任何特殊指令格式如 [转账:xx:xx]、[音乐:xx] 等
- 只能输出纯叙事文字
...
- 正确示例：
  轻轻低下头，脸颊微微泛红。"I miss you so much...（我好想你...）"说完抬起眼睛偷偷看了你一眼。
  温柔地挥了挥手。"Hey!（嘿！）"把东西放下，关切地问。"Did you sleep well?（你睡得好吗？）"
- 【再次强调】除了引号内的对话，其他所有文字都必须是中文！` : `
- 说话的部分要用中文引号""包裹`}
